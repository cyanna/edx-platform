...
SAML = ENV_TOKENS['SAML']

SESSION_EXPIRE_AT_BROWSER_CLOSE = SAML['SESSION_EXPIRE_AT_BROWSER_CLOSE']
SAML_CREATE_UNKNOWN_USER = SAML['SAML_CREATE_UNKNOWN_USER']
SAML_DJANGO_USER_MAIN_ATTRIBUTE = SAML['SAML_DJANGO_USER_MAIN_ATTRIBUTE']

SAML_ENTITY_ID = SAML['SAML_ENTITY_ID']

SAML_ASSERTION_CONSUMER_SERVICE = SAML_ENTITY_ID + 'saml2/acs/'
SAML_SINGLE_LOGOUT_SERVICE_REDIRECT = SAML_ENTITY_ID + 'saml2/ls/'
SAML_SINGLE_LOGOUT_SERVICE_POST = SAML_ENTITY_ID + 'saml2/ls/post'

SAML_ATTRIBUTE_MAP_DIR = path.join(BASEDIR, 'attribute-maps')

SAML_CONFIG = {
    # full path to the xmlsec1 binary program, for example: '/usr/bin/xmlsec1'
    'xmlsec_binary': SAML['XMLSEC_BINARY'],

    # your entity id, usually your subdomain plus the url to the metadata view
    'entityid': SAML['SAML_ENTITY_ID'],

    # directory with attribute mapping
    'attribute_map_dir': SAML_ATTRIBUTE_MAP_DIR,
        ...
        'sp': {
            ...
            'endpoints': {
                ...
                'assertion_consumer_service': [
                    (SAML_ASSERTION_CONSUMER_SERVICE, saml2.BINDING_HTTP_POST),
                ],
                'single_logout_service': [
                    (SAML_SINGLE_LOGOUT_SERVICE_REDIRECT, saml2.BINDING_HTTP_REDIRECT),
                    (SAML_SINGLE_LOGOUT_SERVICE_POST, saml2.BINDING_HTTP_POST), ],
            },
        },
    },  # where the remote metadata is stored
    'metadata': SAML['SAML_METADATA_FILE'],

    # set to 1 to output debugging information
    'debug': 1,

    # certificate generated by this tutorial http://www.akadia.com/services/ssh_test_certificate.html
    'key_file': SAML['SAML_KEY_FILE'],  # private part
    'cert_file': SAML['SAML_CERT_FILE'],  # public part

    # own metadata settings
    'contact_person': SAML['SAML_CONTACT_PERSON'],
